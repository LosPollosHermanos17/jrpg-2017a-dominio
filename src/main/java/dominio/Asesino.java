...
public class Asesino extends Casta {
  ...
  /**
   * Inicializa un objeto Asesino con los parametros especificados, utilizando el constructor de la
   * clase padre "Casta".
   * 
   * @param probCrit
   *          - probabilidad de golpe crítico inicial.
   * @param evasion
   *          - probabilidad de evitar daño inicial.
   * @param danioCrit
   *          - cantidad de daño al realizar un golpe crítico.
   */
   ...
   * 
   * @param caster
   *          - objeto de tipo Personaje atacante.
   * @param atacado
   *          - objeto que implementa Peleable atacado.
   ...
   * 
   * @param caster
   *          - objeto de tipo Personaje que aumenta su probabilidad de evasión.
   * @param atacado
   *          - objeto que implementa Peleable atacado.
   * @return true si el personaje pudo aumentar su probabilidad de evasion o false en caso
   *         contrario.
   */
   ...
   * 
   * @param p
   *          - objeto Personaje a inicializar.
   */
