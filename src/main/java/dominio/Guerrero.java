...
public class Guerrero extends Casta {
	...
	/**
	 * Permite que un personaje pueda atacar a otro personaje con el doble de
	 * fuerza
	...
	/**
	 * Permite que un personaje pueda atacar a otro personaje anulando su
	 * defensa
	 * @param caster : Es el personaje atacante
	 * @param atacado : Es el personaje que recibe el ataque.
	 * @return True si el personaje pudo atacar al otro personaje.
	...
	/**
	 * Inicializa un Personaje de tipo Guerrero, incrementando su atributo
	 * <b>fuerza</b>.
